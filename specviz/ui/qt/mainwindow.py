...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.createSubWindowButton = QtWidgets.QToolButton(self.dockWidgetContents)
        self.createSubWindowButton.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/img/Template-50.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.createSubWindowButton.setIcon(icon)
        self.createSubWindowButton.setIconSize(QtCore.QSize(20, 20))
        self.createSubWindowButton.setObjectName("createSubWindowButton")
        self.horizontalLayout_2.addWidget(self.createSubWindowButton)
        self.addToSubWindowButton = QtWidgets.QToolButton(self.dockWidgetContents)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/img/Change Theme-50.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.addToSubWindowButton.setIcon(icon1)
        self.addToSubWindowButton.setIconSize(QtCore.QSize(20, 20))
        self.addToSubWindowButton.setObjectName("addToSubWindowButton")
        self.horizontalLayout_2.addWidget(self.addToSubWindowButton)
        ...
        self.formLayout_3.setContentsMargins(1, 1, 1, 12)
        ...
        self.formLayout_3.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.currentLayerLabel)
        self.currentLayerLineEdit = QtWidgets.QLineEdit(self.dockWidgetContents_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.currentLayerLineEdit.sizePolicy().hasHeightForWidth())
        self.currentLayerLineEdit.setSizePolicy(sizePolicy)
        self.currentLayerLineEdit.setStyleSheet("QLineEdit{background: #DDDDDD;}")
        self.currentLayerLineEdit.setReadOnly(True)
        self.currentLayerLineEdit.setObjectName("currentLayerLineEdit")
        self.formLayout_3.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.currentLayerLineEdit)
        self.verticalLayout_7.addLayout(self.formLayout_3)
        self.statsTabWidget = QtWidgets.QTabWidget(self.dockWidgetContents_2)
        ...
        self.dataPointCountLineEdit.setStyleSheet("QLineEdit{background: #DDDDDD;}")
        ...
        self.totalLineEdit.setStyleSheet("QLineEdit{background: #DDDDDD;}")
        ...
        self.standardDeviationLineEdit.setStyleSheet("QLineEdit{background: #DDDDDD;}")
        ...
        self.medianLineEdit.setStyleSheet("QLineEdit{background: #DDDDDD;}")
        ...
        self.meanLineEdit.setEnabled(True)
        self.meanLineEdit.setStyleSheet("QLineEdit{background: #DDDDDD;}")
        ...
        self.statsTabWidget.addTab(self.basicTab, "")
        ...
        self.centroidLabel.setEnabled(True)
        ...
        self.centroidLineEdit.setEnabled(True)
        self.centroidLineEdit.setStyleSheet("QLineEdit{background: #DDDDDD;}")
        ...
        self.equivalentWidthLineEdit.setStyleSheet("QLineEdit{background: #DDDDDD;}")
        ...
        self.fluxLabel = QtWidgets.QLabel(self.measuredTab)
        self.fluxLabel.setObjectName("fluxLabel")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.fluxLabel)
        self.fluxLineEdit = QtWidgets.QLineEdit(self.measuredTab)
        self.fluxLineEdit.setStyleSheet("QLineEdit{background: #DDDDDD;}")
        self.fluxLineEdit.setReadOnly(True)
        self.fluxLineEdit.setObjectName("fluxLineEdit")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.fluxLineEdit)
        self.meanContinuumLabel = QtWidgets.QLabel(self.measuredTab)
        self.meanContinuumLabel.setObjectName("meanContinuumLabel")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.meanContinuumLabel)
        self.meanContinuumLineEdit = QtWidgets.QLineEdit(self.measuredTab)
        self.meanContinuumLineEdit.setStyleSheet("QLineEdit{background: #DDDDDD;}")
        self.meanContinuumLineEdit.setReadOnly(True)
        self.meanContinuumLineEdit.setObjectName("meanContinuumLineEdit")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.meanContinuumLineEdit)
        self.verticalLayout_9.addLayout(self.formLayout)
        self.statsTabWidget.addTab(self.measuredTab, "")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 306, 553))
        ...
        self.saveModelButton = QtWidgets.QToolButton(self.groupBox_3)
        self.saveModelButton.setEnabled(False)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/img/Save-48.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.saveModelButton.setIcon(icon5)
        self.saveModelButton.setIconSize(QtCore.QSize(20, 20))
        self.saveModelButton.setObjectName("saveModelButton")
        self.horizontalLayout_6.addWidget(self.saveModelButton)
        self.loadModelButton = QtWidgets.QToolButton(self.groupBox_3)
        self.loadModelButton.setEnabled(False)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/img/Open Folder-48.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.loadModelButton.setIcon(icon6)
        ...
        self.modelRemoveButton.setIcon(icon2)
        self.modelRemoveButton.setIconSize(QtCore.QSize(20, 20))
        self.modelRemoveButton.setObjectName("modelRemoveButton")
        self.horizontalLayout_6.addWidget(self.modelRemoveButton)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.createSubWindowButton.setToolTip(_translate("MainWindow", "Create new plot window from data"))
        self.addToSubWindowButton.setToolTip(_translate("MainWindow", "Add data to current plot window"))
        self.addToSubWindowButton.setText(_translate("MainWindow", "..."))
        ...
        self.statsTabWidget.setTabText(self.statsTabWidget.indexOf(self.basicTab), _translate("MainWindow", "Basic"))
        ...
        self.fluxLabel.setText(_translate("MainWindow", "Flux"))
        self.meanContinuumLabel.setText(_translate("MainWindow", "Mean Continuum"))
        self.statsTabWidget.setTabText(self.statsTabWidget.indexOf(self.measuredTab), _translate("MainWindow", "Measured"))
        ...
        self.saveModelButton.setToolTip(_translate("MainWindow", "Save current models"))

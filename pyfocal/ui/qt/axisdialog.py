...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.redshiftAmountLabel = QtWidgets.QLabel(self.redshiftGroupBox)
        self.redshiftAmountLabel.setObjectName("redshiftAmountLabel")
        self.horizontalLayout_2.addWidget(self.redshiftAmountLabel)
        self.redshiftAmountLineEdit = QtWidgets.QLineEdit(self.redshiftGroupBox)
        self.redshiftAmountLineEdit.setObjectName("redshiftAmountLineEdit")
        self.horizontalLayout_2.addWidget(self.redshiftAmountLineEdit)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.redshiftAmountLabel.setText(_translate("Dialog", "Amount"))

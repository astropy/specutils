...
from specutils.io.registry import io_registry
...
class Spectrum1D(NDSlicingMixin, NDArithmeticMixin, NDData):
    ...
    @classmethod
    def from_array(cls, dispersion, flux, dispersion_unit=None, wcs=None,
        ...
        return cls(flux=flux, wcs=wcs, unit=unit, uncertainty=uncertainty,
                   mask=mask, meta=meta)
    ...
    def read(cls, *args, **kwargs):
        ...
        using syntax such as::
          >>> from specutils.core.spectrum1d import Spectrum1D
    ...
    def __init__(self, flux, wcs, unit=None, uncertainty=None, mask=None,
        ...
        for key in list(self._wcs_attributes):
            ...
            if not unit_equivalent:
                # If unit is not convertible to wcs attribute - delete that
                # wcs attribute
